...
const MOCK_PARTICIPANTS: ParticipantRecord[] = [
  {
    id: 'DMJ-902144',
    fullName: 'Rtr. Rohan Malhotra',
    email: 'rohan.m@rotaract3141.org',
    phone: '+91 98201 12345',
    participantType: 'external',
    districtNumber: '3141',
    clubName: 'Rotaract Club of Bombay Midtown',
    rotaryRole: 'Club President',
    status: 'confirmed',
    arrivalMode: 'Flight',
    arrivalLocation: 'IGI Airport T3',
    tshirtSize: 'L',
    dietaryPreference: 'veg',
    hostClubName: 'RAC Delhi South Central',
    createdAt: '2026-03-10T11:20:00Z',
  },
  {
    id: 'DMJ-441209',
    fullName: 'Rtr. Ananya Sengupta',
    email: 'ananya.s@rotaract3291.org',
    phone: '+91 98305 67890',
    participantType: 'external',
    districtNumber: '3291',
    clubName: 'Rotaract Club of Calcutta Park East',
    rotaryRole: 'Director ISD',
    status: 'approved',
    arrivalMode: 'Train',
    arrivalLocation: 'New Delhi Railway Station (NDLS)',
    tshirtSize: 'M',
    dietaryPreference: 'non_veg',
    hostClubName: 'RAC Delhi Central',
    createdAt: '2026-03-11T14:45:00Z',
  },
  {
    id: 'DMJ-819203',
    fullName: 'Rtr. Pradeep Nair',
    email: 'pradeep.nair@rotaract3201.org',
    phone: '+91 94471 23456',
    participantType: 'external',
    districtNumber: '3201',
    clubName: 'Rotaract Club of Coimbatore Metropolis',
    rotaryRole: 'Vice President',
    status: 'pending',
    arrivalMode: 'Flight',
    arrivalLocation: 'IGI Airport T2',
    tshirtSize: 'XL',
    dietaryPreference: 'veg',
  ...
  {
    id: 'DMJ-550212',
    fullName: 'Rtr. Simran Kaur',
    email: 'simran@rotaract3011.org',
    phone: '+91 98112 34567',
    participantType: 'internal_rotaractor',
    districtNumber: '3011',
    clubName: 'Rotaract Club of Delhi Elite',
    rotaryRole: 'Secretary',
    status: 'confirmed',
    arrivalMode: 'Local',
    arrivalLocation: 'Delhi NCR',
    tshirtSize: 'S',
    dietaryPreference: 'veg',
  ...
  {
    id: 'DMJ-772910',
    fullName: 'Rtr. Tenzing Norbu',
    email: 'tenzing@rotaract3292.org',
    phone: '+977 98412 34567',
    participantType: 'external',
    districtNumber: '3292',
    clubName: 'Rotaract Club of Kathmandu North',
    rotaryRole: 'International Delegate',
    status: 'waitlist',
    arrivalMode: 'Flight',
    arrivalLocation: 'IGI Airport T3',
    tshirtSize: 'M',
